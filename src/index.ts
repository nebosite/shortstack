import { ShortStackOptions, ShortStackNewOptions, ShortStackListOptions, ShortStackFinishOptions, ShortStackStatusOptions, ShortStackPurgeOptions, ShortStackPushOptions, ShortStackNextOptions, ShortStackGoOptions, ShortStackMergeOptions, ShortStackFetchOptions } from "./ShortStackOptions";
...
async function main() {
    ...
    try {
        ...
        switch(options.action.commandName)
        {
            ...
            case "fetch":   await handler.fetch(options.action! as ShortStackFetchOptions); break;
